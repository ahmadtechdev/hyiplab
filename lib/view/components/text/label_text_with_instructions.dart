...
class LabelTextInstruction extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return isRequired
        ? Row(
            children: [
              Text(text.tr, textAlign: textAlign, style: textStyle ?? interSemiBoldDefault.copyWith(color: MyColor.getPrimaryTextColor())),
              const SizedBox(
                width: 2,
              ),
        ...
        : Row(
            children: [
              Text(
                text.tr,
                textAlign: textAlign,
                style: textStyle ?? interSemiBoldDefault.copyWith(color: MyColor.getPrimaryTextColor()),
              ),
              if (instructions != null) ...[
                Padding(
                  padding: const EdgeInsetsDirectional.only(start: 2, end: Dimensions.space10),
                  child: Tooltip(
                      ...
                      child: GestureDetector(
                        ...
                        child: Icon(
                          Icons.info_outline_rounded,
                          size: Dimensions.space15,
                          color: MyColor.getLabelTextColor().withValues(alpha:0.8),
                        ),
                      )),
                ),
              ],
