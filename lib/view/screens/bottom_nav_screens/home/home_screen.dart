                  ...
                  child: Column(
                    children: [
                            ...
                            children: [
                              Expanded(
                                child: CardWithRoundIcon(
                                  backgroundColor: MyColor.getScreenBgColor(),
                                  titleText: MyStrings.depositWallet.tr,
                      ...
                      InkWell(
                        ...
                        child: SizedBox(
                          height: 30, width: 30,
                          child: Icon(controller.isExpand ? Icons.keyboard_arrow_up : Icons.keyboard_arrow_down, color: MyColor.getTextColor().withValues(alpha:0.5), size: 20),
                        )
                      ),
                      const SizedBox(height: Dimensions.space15),
