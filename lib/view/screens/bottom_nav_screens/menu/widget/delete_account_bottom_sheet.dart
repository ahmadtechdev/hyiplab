              ...
              children: [
                 Align(
                  ...
                  child: IconButton(onPressed:(){
                    Get.back();
                  },icon:Icon(Icons.clear,size: 22,color: MyColor.getTextColor()),padding: EdgeInsets.zero,),
                ),
                const SizedBox(height: Dimensions.space12),
                SvgPicture.asset(MyImages.userDeleteImage, width: 110, height: 110, fit: BoxFit.cover,color: MyColor.redCancelTextColor,),
                const SizedBox(height: Dimensions.space25),
                Text(
                  MyStrings.deleteYourAccount,
                  style: interRegularDefault.copyWith(color: MyColor.getTextColor(), fontSize: Dimensions.fontMediumLarge),
                  textAlign: TextAlign.center,
                ),
                const SizedBox(height: Dimensions.space25),
                Text(
                  MyStrings.deleteBottomSheetSubtitle,
                  style: interRegularDefault.copyWith(color: MyColor.getTextColor1(), fontSize: Dimensions.fontDefault),
                  textAlign: TextAlign.center,
                ),
                ...
                GestureDetector(
                  onTap: () {
                    if (widget.controller.passwordDeleteController.text.isNotEmpty) {
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: menuController.isDeleteBtnLoading
                        ...
                        style: interMediumDefault.copyWith(color: MyColor.delteBtnTextColor, fontSize: Dimensions.fontExtraLarge),
                      ),
                    ),
                  ),
                ),
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 17),
                    decoration: BoxDecoration(
                      color: MyColor.getTextColor1().withValues(alpha:.1),
                      borderRadius: BorderRadius.circular(12),
                    ),
                    child: Center(
                      child: Text(
                        MyStrings.cancel,
                        style: interMediumDefault.copyWith(color: MyColor.getTextColor(), fontSize: Dimensions.fontExtraLarge),
                      ),
                    ),
                  ),
                ),
