                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: interRegularLarge.copyWith(color: MyColor.getTextColor1(), fontWeight: FontWeight.w500)),
                    ],
                  ),
                  InkWell(
                    onTap: () {
                    ...
                    child: Icon(widget.index == controller.selectedIndex ? Icons.keyboard_arrow_up : Icons.keyboard_arrow_down, color: MyColor.getSelectedIconColor().withValues(alpha:.7), size: 25),
                  )
                ],
              ),
              ExpandedSection(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text( "${MyStrings.investTill.tr} ", style: interSemiBoldDefault.copyWith(color: MyColor.getTextColor())),
                        const SizedBox(width: Dimensions.space10),
                        Text( DateConverter.nextReturnTime(controller.poolList[widget.index].startDate.toString()),style: interRegularDefault.copyWith(color: MyColor.getTextColor())),
                      ],
                    ),
                    const CustomDivider(space: Dimensions.space15),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text( "${MyStrings.returnDate.tr} ", style: interSemiBoldDefault.copyWith(color: MyColor.getTextColor())),
                        const SizedBox(width: Dimensions.space10),
                        Text( DateConverter.nextReturnTime(controller.poolList[widget.index].endDate.toString()),style: interRegularDefault.copyWith(color: MyColor.getTextColor())),
                      ],
                    ),
                    const CustomDivider(space: Dimensions.space15),
                    Row(
                      ...
                      children: [
                        Expanded(
                          child: RichText(
                            ...
                            text: TextSpan(
                              children: [
                                TextSpan(text: "${MyStrings.investedAmount.tr} ", style: interSemiBoldDefault.copyWith(color: MyColor.getTextColor())),
                                TextSpan(
                                  text: "  ${controller.curSymbol}${Converter.roundDoubleAndRemoveTrailingZero(controller.poolList[widget.index].investedAmount??"0")}/ ${controller.curSymbol}${Converter.roundDoubleAndRemoveTrailingZero(controller.poolList[widget.index].amount??"0")}",
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text( "${MyStrings.interestRange.tr} ", style: interSemiBoldDefault.copyWith(color: MyColor.getTextColor())),
                        const SizedBox(width: Dimensions.space10),
                        Text( (controller.poolList[widget.index].interestRange ?? ""),style: interSemiBoldDefault.copyWith(color: MyColor.getPrimaryColor())),
                      ],
                    ),
                    // const CustomDivider(space: Dimensions.space15),
