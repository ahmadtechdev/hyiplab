...
class _RankingScreenState extends State<RankingScreen> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<RankingController>(builder: (controller)=>SafeArea(
      child: Scaffold(
        ...
        body: controller.isLoading?const CustomLoader(): SingleChildScrollView(
          child: Padding(
            ...
            child: controller.allRankList.isEmpty? const NoDataFoundScreen() : Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Visibility(
                  visible: controller.nextRanking != null && controller.nextRanking?.name != null,
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Row(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(MyStrings.teamInvest.tr,style: interRegularDefault.copyWith(color: MyColor.getSecondaryTextColor())),
                            Expanded(child: Text("${controller.curSymbol}${Converter.twoDecimalPlaceFixedWithoutRounding(controller.user?.teamInvests??'0')} / ${controller.curSymbol}${Converter.twoDecimalPlaceFixedWithoutRounding(controller.nextRanking?.minReferralInvest??'0')}",textAlign:TextAlign.end,style: interRegularDefault.copyWith(color: MyColor.primaryColor,fontWeight: FontWeight.w600))),
                          ],
                        ),
                        const CustomDivider(space: Dimensions.space12),
                        Row(
                          ...
                          children: [
                            Expanded(child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text(MyStrings.bonus.tr,style: interRegularDefault.copyWith(color: MyColor.getSecondaryTextColor())),
                                Text("${controller.curSymbol}${Converter.twoDecimalPlaceFixedWithoutRounding(controller.nextRanking?.bonus??'')}",style: interRegularDefault.copyWith(color: MyColor.primaryColor,fontWeight: FontWeight.w600)),
                            ...
                            Expanded(child:  Column(
                              ...
                              children: [
                                Text(MyStrings.directReferral.tr,style: interRegularDefault.copyWith(color: MyColor.getSecondaryTextColor())),
                                Text("${controller.totalReffered}/${controller.nextRanking?.minReferral}",style: interRegularDefault.copyWith(color: MyColor.primaryColor,fontWeight: FontWeight.w600)),
                              ],
                            ))
                          ],
                        )
