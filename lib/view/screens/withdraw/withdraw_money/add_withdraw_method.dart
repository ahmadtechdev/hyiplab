...
import '../../../components/campaign_card_wieget.dart';
...
class _AddWithdrawMethodState extends State<AddWithdrawMethod> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<AddNewWithdrawController>(
      ...
      controller.model.data?.isHoliday == "true" ?
      Column(
        children: [
          Text(MyStrings.workingDayMessage.tr,style: interRegularDefault.copyWith(color: MyColor.getPrimaryTextColor()),textAlign: TextAlign.center,),
          const SizedBox(height: Dimensions.space10,),
          Text(MyStrings.nextWorkingDay.tr,style: interRegularLarge.copyWith(color: MyColor.redCancelTextColor),),
          const SizedBox(height: Dimensions.space10,),
          CampaignCardWidget(
            deadline: DateTime.now().add(Duration(days: controller.days,hours: controller.hours,minutes: controller.minutes,seconds: controller.seconds)),
          ),
        ],
      ):
